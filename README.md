...
<details>
<summary>Codex 하네스 엔지니어링</summary>
...
<details>
<summary>Agent 하네스 및 진행 항목</summary>
...
- [x] MIT 라이선스 추가
- [x] GitHub Pages settings에서 source를 GitHub Actions로 활성화
